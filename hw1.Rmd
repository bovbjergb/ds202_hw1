...
As a political science major I'm interested in the intersection of public policy and data science.The **University of Chicago** runs a center for data science and public policy and the data scienctists working there have been attempting to develop [early warning system](http://www.datasciencepublicpolicy.org/projects/public-safety/early-warning-and-intervention-systems-for-police-departments/). 

This project has been in tandum with the police department of chicago, which demonstrates the ability of data science to be flexible and open the door to many different careers. ![](https://i.ytimg.com/vi/W7hPlpkFZq8/hqdefault.jpg)
